                ...
                {status === 'success' ? (
                    ...
                    <form onSubmit={handleSubmit} className="px-5 py-5 space-y-4">
                        ...
                        <div className="flex items-center justify-end gap-3 border-t border-white/8 pt-4">
                            <button type="button" onClick={onClose} className="rounded-lg px-4 py-2.5 text-[11px] text-white/42 transition-colors hover:text-white/72">
                                Cancel
                            </button>
                            <button
                                type="submit"
                                disabled={status === 'sending'}
                                className="flex items-center gap-2 rounded-lg bg-brand-gold px-5 py-2.5 text-[11px] font-semibold text-brand-deep transition-opacity disabled:opacity-50"
                            >
                                <Send size={11} />
